var member = (function(){
	...
	var onCreate = function(){
		...
		$('.util li:nth-child(1)').click(function(e){
			e.preventDefault();
			$.ajax({
				...
				success : function(data) {
					if (data.message === 'success') {
						...
						$('#login_btn').click(function(e) {
							e.preventDefault();
							$.ajax({
								url : app.context()+'/member/card',
								success : function(data) {
									alert('signin success 진입성공'+data.message);
									$('#pub_article').html('<h1>로긴성공</h1>');
									member.init();
								},
		...
		$('#content_regist_btn, .util li:nth-child(2)').click(function(e) {
			e.preventDefault();
			$.ajax({
...
+'<a class="btnS pwB"><span>변경</span></a></td></tr>'
+'<tr>'
...
+'<a class="btnS mobileB"><span>변경</span></a>'
+'</td>'
+'</tr>'
+'<tr>'
...
+'<a id="execDaumPostcode" onclick="javascript:execDaumPostcode();" class="btnS"><span>우편번호</span></a>'
+'<p class="mt5">'
...
+'</div>'
+'<a class="card_del btn_del">삭제하기</a>'
+'</li>'
+'<li class="lst" id="open_register_card_layer_li">'
+'<a class="btn" id="open_register_card_layer"><img src="resources/img/mypage/btn_card_add.gif" /></a>'
+'</li>'
+'</ul>'
...
+'<div class="login_container">'
+'<label><b></b></label>'
+'<input class="login_input" type="text" placeholder="ID" name="uname" required><br />'
+'<label><b></b></label>'
+'<input class="login_input" type="password" placeholder="Password" name="psw" required><br />'
